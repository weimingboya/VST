...
class BertLayer(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        # self.bert_gv_cross_FFN = bert_gv_cross_FFN
    ...
    def from_config(cls, cfg):
        return {
            ...
            # "bert_gv_cross_FFN": BertFFN(cfg),
        }

    # def forward(self, visn_feats, text_feats, gv_feats, ext_vmasks, region_ape, text_ape, r2r_rpe, r2t_rpe, t2t_rpe, t2r_rpe):
    ...
    def forward(self, batched_inputs, mode=None):
        ...
        if mode == None or mode == 'v':
            ...
            for i, layer_module in enumerate(self.layers):
                # visn_feats, text_feats, gv_feats = layer_module(visn_feats, text_feats, gv_feats, ext_vmasks, region_ape, text_ape, r2r_rpe, r2t_rpe, t2t_rpe, t2r_rpe)
            ...
            # ret.update( {kfg.ATT_FEATS: cat_feats, kfg.EXT_ATT_MASKS: cat_ext_vmasks, kfg.GLOBAL_FEATS: gv_feats})
            # ret.update( {kfg.ATT_FEATS: visn_feats, kfg.ATT_FEATS_WO_MASK: text_feats, kfg.EXT_ATT_MASKS: ext_vmasks})
            ret.update( {kfg.ATT_FEATS: cat_feats, kfg.EXT_ATT_MASKS: cat_ext_vmasks})
        return ret